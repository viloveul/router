...
$route1 = $router->dispatch('GET', '/hello/zafex')->routed();
$route2 = $router->dispatch('GET', '/foo/hello-world')->routed();
$route3 = $router->dispatch('GET', '/test/fajrul-akbar-zuhdi')->routed();
